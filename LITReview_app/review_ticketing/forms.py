...
class TicketForm(forms.ModelForm):
	...
	title = forms.CharField(label="Titre", widget=forms.Textarea(attrs=
								{"class": "form-control",
...
class ReviewForm(forms.ModelForm):
	...
	headline = forms.CharField(label="Titre", widget=forms.Textarea(attrs=
								{"class": "form-control",
								"placeholder": "Titre de la critique",
								"cols": 60,
								"rows": 1}))

	body = forms.CharField(label="Description", widget=forms.Textarea(attrs=
							{"class": "form-control",
